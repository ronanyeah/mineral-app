...
export function isRuleKey(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V25}::token::RuleKey` + '<'); }
...
export class RuleKey<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 isProtected: bcs.bool()

}) };

 static fromFields<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, fields: Record<string, any> ): RuleKey<ToPhantomTypeArgument<T>> { return RuleKey.reified( typeArg, ).new( { isProtected: decodeFromFields("bool", fields.isProtected) } ) }
 ...
 return RuleKey.reified( typeArg, ).new( { isProtected: decodeFromFieldsWithTypes("bool", item.fields.isProtected) } ) }
...
export function isActionRequest(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V25}::token::ActionRequest` + '<'); }
...
export class ActionRequest<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V25}::token::ActionRequest`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = ActionRequest.$typeName; readonly $fullTypeName: `${typeof PKG_V25}::token::ActionRequest<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = ActionRequest.$isPhantom;
 ...
 private constructor(typeArgs: [PhantomToTypeStr<T>], fields: ActionRequestFields<T>, ) { this.$fullTypeName = composeSuiType( ActionRequest.$typeName, ...typeArgs ) as `${typeof PKG_V25}::token::ActionRequest<${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;
 ...
 name: String.bcs, amount: bcs.u64(), sender: bcs.bytes(32).transform({ input: (val: string) => fromHEX(val), output: (val: Uint8Array) => toHEX(val), }), recipient: Option.bcs(bcs.bytes(32).transform({ input: (val: string) => fromHEX(val), output: (val: Uint8Array) => toHEX(val), })), spentBalance: Option.bcs(Balance.bcs), approvals: VecSet.bcs(TypeName.bcs)

}) };

 static fromFields<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, fields: Record<string, any> ): ActionRequest<ToPhantomTypeArgument<T>> { return ActionRequest.reified( typeArg, ).new( { name: decodeFromFields(String.reified(), fields.name), amount: decodeFromFields("u64", fields.amount), sender: decodeFromFields("address", fields.sender), recipient: decodeFromFields(Option.reified("address"), fields.recipient), spentBalance: decodeFromFields(Option.reified(Balance.reified(typeArg)), fields.spentBalance), approvals: decodeFromFields(VecSet.reified(TypeName.reified()), fields.approvals) } ) }
...
export function isToken(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V25}::token::Token` + '<'); }
...
export class Token<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V25}::token::Token`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = Token.$typeName; readonly $fullTypeName: `${typeof PKG_V25}::token::Token<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = Token.$isPhantom;

 readonly id: ToField<UID>; readonly balance: ToField<Balance<T>>

 private constructor(typeArgs: [PhantomToTypeStr<T>], fields: TokenFields<T>, ) { this.$fullTypeName = composeSuiType( Token.$typeName, ...typeArgs ) as `${typeof PKG_V25}::token::Token<${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;

 this.id = fields.id;; this.balance = fields.balance; }

 static reified<T extends PhantomReified<PhantomTypeArgument>>( T: T ): TokenReified<ToPhantomTypeArgument<T>> { return { typeName: Token.$typeName, fullTypeName: composeSuiType( Token.$typeName, ...[extractType(T)] ) as `${typeof PKG_V25}::token::Token<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`, typeArgs: [ extractType(T) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>], isPhantom: Token.$isPhantom, reifiedTypeArgs: [T], fromFields: (fields: Record<string, any>) => Token.fromFields( T, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Token.fromFieldsWithTypes( T, item, ), fromBcs: (data: Uint8Array) => Token.fromBcs( T, data, ), bcs: Token.bcs, fromJSONField: (field: any) => Token.fromJSONField( T, field, ), fromJSON: (json: Record<string, any>) => Token.fromJSON( T, json, ), fromSuiParsedData: (content: SuiParsedData) => Token.fromSuiParsedData( T, content, ), fromSuiObjectData: (content: SuiObjectData) => Token.fromSuiObjectData( T, content, ), fetch: async (client: SuiClient, id: string) => Token.fetch( client, T, id, ), new: ( fields: TokenFields<ToPhantomTypeArgument<T>>, ) => { return new Token( [extractType(T)], fields ) }, kind: "StructClassReified", } }
...
export function isTokenPolicy(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V25}::token::TokenPolicy` + '<'); }
...
export class TokenPolicy<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 id: UID.bcs, spentBalance: Balance.bcs, rules: VecMap.bcs(String.bcs, VecSet.bcs(TypeName.bcs))

}) };

 static fromFields<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, fields: Record<string, any> ): TokenPolicy<ToPhantomTypeArgument<T>> { return TokenPolicy.reified( typeArg, ).new( { id: decodeFromFields(UID.reified(), fields.id), spentBalance: decodeFromFields(Balance.reified(typeArg), fields.spentBalance), rules: decodeFromFields(VecMap.reified(String.reified(), VecSet.reified(TypeName.reified())), fields.rules) } ) }
 ...
 return TokenPolicy.reified( typeArg, ).new( { id: decodeFromFieldsWithTypes(UID.reified(), item.fields.id), spentBalance: decodeFromFieldsWithTypes(Balance.reified(typeArg), item.fields.spentBalance), rules: decodeFromFieldsWithTypes(VecMap.reified(String.reified(), VecSet.reified(TypeName.reified())), item.fields.rules) } ) }
...
export function isTokenPolicyCap(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V25}::token::TokenPolicyCap` + '<'); }
...
export function isTokenPolicyCreated(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V25}::token::TokenPolicyCreated` + '<'); }
...
export class TokenPolicyCreated<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 id: ID.bcs, isMutable: bcs.bool()

}) };

 static fromFields<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, fields: Record<string, any> ): TokenPolicyCreated<ToPhantomTypeArgument<T>> { return TokenPolicyCreated.reified( typeArg, ).new( { id: decodeFromFields(ID.reified(), fields.id), isMutable: decodeFromFields("bool", fields.isMutable) } ) }
 ...
 return TokenPolicyCreated.reified( typeArg, ).new( { id: decodeFromFieldsWithTypes(ID.reified(), item.fields.id), isMutable: decodeFromFieldsWithTypes("bool", item.fields.isMutable) } ) }
