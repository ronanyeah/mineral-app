...
export class ConfigKey implements StructClass { __StructClass = true as const;
 ...
 perTypeIndex: bcs.u64(), perTypeKey: bcs.vector(bcs.u8())

}) };

 static fromFields( fields: Record<string, any> ): ConfigKey { return ConfigKey.reified( ).new( { perTypeIndex: decodeFromFields("u64", fields.perTypeIndex), perTypeKey: decodeFromFields(reified.vector("u8"), fields.perTypeKey) } ) }

 static fromFieldsWithTypes( item: FieldsWithTypes ): ConfigKey { if (!isConfigKey(item.type)) { throw new Error("not a ConfigKey type");

 }

 return ConfigKey.reified( ).new( { perTypeIndex: decodeFromFieldsWithTypes("u64", item.fields.perTypeIndex), perTypeKey: decodeFromFieldsWithTypes(reified.vector("u8"), item.fields.perTypeKey) } ) }
...
export class ConfigWriteCap implements StructClass { __StructClass = true as const;
 ...
 static fromFields( fields: Record<string, any> ): ConfigWriteCap { return ConfigWriteCap.reified( ).new( { dummyField: decodeFromFields("bool", fields.dummyField) } ) }
 ...
 return ConfigWriteCap.reified( ).new( { dummyField: decodeFromFieldsWithTypes("bool", item.fields.dummyField) } ) }
...
export class GlobalPauseKey implements StructClass { __StructClass = true as const;
 ...
 static fromFields( fields: Record<string, any> ): GlobalPauseKey { return GlobalPauseKey.reified( ).new( { dummyField: decodeFromFields("bool", fields.dummyField) } ) }
 ...
 return GlobalPauseKey.reified( ).new( { dummyField: decodeFromFieldsWithTypes("bool", item.fields.dummyField) } ) }
...
export class PerTypeConfigCreated implements StructClass { __StructClass = true as const;
 ...
 key: ConfigKey.bcs, configId: ID.bcs

}) };

 static fromFields( fields: Record<string, any> ): PerTypeConfigCreated { return PerTypeConfigCreated.reified( ).new( { key: decodeFromFields(ConfigKey.reified(), fields.key), configId: decodeFromFields(ID.reified(), fields.configId) } ) }
 ...
 return PerTypeConfigCreated.reified( ).new( { key: decodeFromFieldsWithTypes(ConfigKey.reified(), item.fields.key), configId: decodeFromFieldsWithTypes(ID.reified(), item.fields.configId) } ) }
...
export class PerTypeList implements StructClass { __StructClass = true as const;
 ...
 id: UID.bcs, deniedCount: Table.bcs, deniedAddresses: Table.bcs

}) };

 static fromFields( fields: Record<string, any> ): PerTypeList { return PerTypeList.reified( ).new( { id: decodeFromFields(UID.reified(), fields.id), deniedCount: decodeFromFields(Table.reified(reified.phantom("address"), reified.phantom("u64")), fields.deniedCount), deniedAddresses: decodeFromFields(Table.reified(reified.phantom(reified.vector("u8")), reified.phantom(VecSet.reified("address"))), fields.deniedAddresses) } ) }
 ...
 return PerTypeList.reified( ).new( { id: decodeFromFieldsWithTypes(UID.reified(), item.fields.id), deniedCount: decodeFromFieldsWithTypes(Table.reified(reified.phantom("address"), reified.phantom("u64")), item.fields.deniedCount), deniedAddresses: decodeFromFieldsWithTypes(Table.reified(reified.phantom(reified.vector("u8")), reified.phantom(VecSet.reified("address"))), item.fields.deniedAddresses) } ) }
