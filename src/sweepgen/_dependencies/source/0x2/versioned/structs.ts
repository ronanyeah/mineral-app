...
export class VersionChangeCap implements StructClass { __StructClass = true as const;
 ...
 versionedId: ID.bcs, oldVersion: bcs.u64()

}) };

 static fromFields( fields: Record<string, any> ): VersionChangeCap { return VersionChangeCap.reified( ).new( { versionedId: decodeFromFields(ID.reified(), fields.versionedId), oldVersion: decodeFromFields("u64", fields.oldVersion) } ) }
 ...
 return VersionChangeCap.reified( ).new( { versionedId: decodeFromFieldsWithTypes(ID.reified(), item.fields.versionedId), oldVersion: decodeFromFieldsWithTypes("u64", item.fields.oldVersion) } ) }
