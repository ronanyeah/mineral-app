...
export function isConfig(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::mine::Config`; }
...
export class Config implements StructClass { static readonly $typeName = `${PKG_V1}::mine::Config`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = Config.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::mine::Config`; readonly $typeArgs: []; readonly $isPhantom = Config.$isPhantom;
 ...
 private constructor(typeArgs: [], fields: ConfigFields, ) { this.$fullTypeName = composeSuiType( Config.$typeName, ...typeArgs ) as `${typeof PKG_V1}::mine::Config`; this.$typeArgs = typeArgs;
...
export function isAdminCap(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::mine::AdminCap`; }

export interface AdminCapFields { id: ToField<UID> }

export type AdminCapReified = Reified< AdminCap, AdminCapFields >;

export class AdminCap implements StructClass { static readonly $typeName = `${PKG_V1}::mine::AdminCap`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = AdminCap.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::mine::AdminCap`; readonly $typeArgs: []; readonly $isPhantom = AdminCap.$isPhantom;

 readonly id: ToField<UID>

 private constructor(typeArgs: [], fields: AdminCapFields, ) { this.$fullTypeName = composeSuiType( AdminCap.$typeName, ...typeArgs ) as `${typeof PKG_V1}::mine::AdminCap`; this.$typeArgs = typeArgs;

 this.id = fields.id; }

 static reified( ): AdminCapReified { return { typeName: AdminCap.$typeName, fullTypeName: composeSuiType( AdminCap.$typeName, ...[] ) as `${typeof PKG_V1}::mine::AdminCap`, typeArgs: [ ] as [], isPhantom: AdminCap.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => AdminCap.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => AdminCap.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => AdminCap.fromBcs( data, ), bcs: AdminCap.bcs, fromJSONField: (field: any) => AdminCap.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => AdminCap.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => AdminCap.fromSuiParsedData( content, ), fetch: async (client: SuiClient, id: string) => AdminCap.fetch( client, id, ), new: ( fields: AdminCapFields, ) => { return new AdminCap( [], fields ) }, kind: "StructClassReified", } }
...
export function isBus(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::mine::Bus`; }
...
export class Bus implements StructClass { static readonly $typeName = `${PKG_V1}::mine::Bus`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = Bus.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::mine::Bus`; readonly $typeArgs: []; readonly $isPhantom = Bus.$isPhantom;
 ...
 private constructor(typeArgs: [], fields: BusFields, ) { this.$fullTypeName = composeSuiType( Bus.$typeName, ...typeArgs ) as `${typeof PKG_V1}::mine::Bus`; this.$typeArgs = typeArgs;
 ...
 static reified( ): BusReified { return { typeName: Bus.$typeName, fullTypeName: composeSuiType( Bus.$typeName, ...[] ) as `${typeof PKG_V1}::mine::Bus`, typeArgs: [ ] as [], isPhantom: Bus.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => Bus.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Bus.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => Bus.fromBcs( data, ), bcs: Bus.bcs, fromJSONField: (field: any) => Bus.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => Bus.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => Bus.fromSuiParsedData( content, ), fetch: async (client: SuiClient, id: string) => Bus.fetch( client, id, ), new: ( fields: BusFields, ) => { return new Bus( [], fields ) }, kind: "StructClassReified", } }
...
export function isMINE(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::mine::MINE`; }

export interface MINEFields { dummyField: ToField<"bool"> }

export type MINEReified = Reified< MINE, MINEFields >;

export class MINE implements StructClass { static readonly $typeName = `${PKG_V1}::mine::MINE`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = MINE.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::mine::MINE`; readonly $typeArgs: []; readonly $isPhantom = MINE.$isPhantom;

 readonly dummyField: ToField<"bool">

 private constructor(typeArgs: [], fields: MINEFields, ) { this.$fullTypeName = composeSuiType( MINE.$typeName, ...typeArgs ) as `${typeof PKG_V1}::mine::MINE`; this.$typeArgs = typeArgs;

 this.dummyField = fields.dummyField; }

 static reified( ): MINEReified { return { typeName: MINE.$typeName, fullTypeName: composeSuiType( MINE.$typeName, ...[] ) as `${typeof PKG_V1}::mine::MINE`, typeArgs: [ ] as [], isPhantom: MINE.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => MINE.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => MINE.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => MINE.fromBcs( data, ), bcs: MINE.bcs, fromJSONField: (field: any) => MINE.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => MINE.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => MINE.fromSuiParsedData( content, ), fetch: async (client: SuiClient, id: string) => MINE.fetch( client, id, ), new: ( fields: MINEFields, ) => { return new MINE( [], fields ) }, kind: "StructClassReified", } }
