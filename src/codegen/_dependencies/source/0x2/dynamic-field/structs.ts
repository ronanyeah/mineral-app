...
export class Field<Name extends TypeArgument, Value extends TypeArgument> implements StructClass { static readonly $typeName = `${PKG_V25}::dynamic_field::Field`; static readonly $numTypeParams = 2; static readonly $isPhantom = [false,false,] as const;
