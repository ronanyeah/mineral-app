...
export class G1 implements StructClass { static readonly $typeName = `${PKG_V25}::bls12381::G1`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;
...
export class G2 implements StructClass { static readonly $typeName = `${PKG_V25}::bls12381::G2`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;
...
export class GT implements StructClass { static readonly $typeName = `${PKG_V25}::bls12381::GT`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;
...
export class Scalar implements StructClass { static readonly $typeName = `${PKG_V25}::bls12381::Scalar`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;
