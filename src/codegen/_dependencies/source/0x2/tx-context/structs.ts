...
export class TxContext implements StructClass { static readonly $typeName = `${PKG_V25}::tx_context::TxContext`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;
