...
export class ObjectBag implements StructClass { static readonly $typeName = `${PKG_V25}::object_bag::ObjectBag`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;
