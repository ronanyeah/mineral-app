...
export class ActiveJwk implements StructClass { static readonly $typeName = `${PKG_V25}::authenticator_state::ActiveJwk`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;
...
export class AuthenticatorState implements StructClass { static readonly $typeName = `${PKG_V25}::authenticator_state::AuthenticatorState`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;
...
export class AuthenticatorStateInner implements StructClass { static readonly $typeName = `${PKG_V25}::authenticator_state::AuthenticatorStateInner`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;
...
export class JWK implements StructClass { static readonly $typeName = `${PKG_V25}::authenticator_state::JWK`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;
...
export class JwkId implements StructClass { static readonly $typeName = `${PKG_V25}::authenticator_state::JwkId`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;
 ...
 static reified( ): JwkIdReified { return { typeName: JwkId.$typeName, fullTypeName: composeSuiType( JwkId.$typeName, ...[] ) as `${typeof PKG_V25}::authenticator_state::JwkId`, typeArgs: [ ] as [], isPhantom: JwkId.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => JwkId.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => JwkId.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => JwkId.fromBcs( data, ), bcs: JwkId.bcs, fromJSONField: (field: any) => JwkId.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => JwkId.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => JwkId.fromSuiParsedData( content, ), fetch: async (client: SuiClient, id: string) => JwkId.fetch( client, id, ), new: ( fields: JwkIdFields, ) => { return new JwkId( [], fields ) }, kind: "StructClassReified", } }
