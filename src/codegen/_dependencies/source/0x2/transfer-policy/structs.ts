...
export class RuleKey<T extends PhantomTypeArgument> implements StructClass { static readonly $typeName = `${PKG_V25}::transfer_policy::RuleKey`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;
...
export class TransferPolicy<T extends PhantomTypeArgument> implements StructClass { static readonly $typeName = `${PKG_V25}::transfer_policy::TransferPolicy`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;
...
export class TransferPolicyCap<T extends PhantomTypeArgument> implements StructClass { static readonly $typeName = `${PKG_V25}::transfer_policy::TransferPolicyCap`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;
...
export class TransferPolicyCreated<T extends PhantomTypeArgument> implements StructClass { static readonly $typeName = `${PKG_V25}::transfer_policy::TransferPolicyCreated`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;
...
export class TransferPolicyDestroyed<T extends PhantomTypeArgument> implements StructClass { static readonly $typeName = `${PKG_V25}::transfer_policy::TransferPolicyDestroyed`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;
...
export class TransferRequest<T extends PhantomTypeArgument> implements StructClass { static readonly $typeName = `${PKG_V25}::transfer_policy::TransferRequest`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;
