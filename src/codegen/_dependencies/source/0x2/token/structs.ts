...
export class RuleKey<T extends PhantomTypeArgument> implements StructClass { static readonly $typeName = `${PKG_V25}::token::RuleKey`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;
...
export class ActionRequest<T extends PhantomTypeArgument> implements StructClass { static readonly $typeName = `${PKG_V25}::token::ActionRequest`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;
...
export class Token<T extends PhantomTypeArgument> implements StructClass { static readonly $typeName = `${PKG_V25}::token::Token`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;
...
export class TokenPolicy<T extends PhantomTypeArgument> implements StructClass { static readonly $typeName = `${PKG_V25}::token::TokenPolicy`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;
...
export class TokenPolicyCap<T extends PhantomTypeArgument> implements StructClass { static readonly $typeName = `${PKG_V25}::token::TokenPolicyCap`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;
...
export class TokenPolicyCreated<T extends PhantomTypeArgument> implements StructClass { static readonly $typeName = `${PKG_V25}::token::TokenPolicyCreated`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;
