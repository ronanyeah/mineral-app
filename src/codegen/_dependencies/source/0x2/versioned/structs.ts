...
export class VersionChangeCap implements StructClass { static readonly $typeName = `${PKG_V25}::versioned::VersionChangeCap`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;
...
export class Versioned implements StructClass { static readonly $typeName = `${PKG_V25}::versioned::Versioned`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;
