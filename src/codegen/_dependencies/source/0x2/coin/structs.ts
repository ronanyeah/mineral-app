...
export class Coin<T extends PhantomTypeArgument> implements StructClass { static readonly $typeName = `${PKG_V25}::coin::Coin`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;
...
export class CoinMetadata<T extends PhantomTypeArgument> implements StructClass { static readonly $typeName = `${PKG_V25}::coin::CoinMetadata`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;
...
export class CurrencyCreated<T extends PhantomTypeArgument> implements StructClass { static readonly $typeName = `${PKG_V25}::coin::CurrencyCreated`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;
...
export class DenyCap<T extends PhantomTypeArgument> implements StructClass { static readonly $typeName = `${PKG_V25}::coin::DenyCap`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;
...
export class RegulatedCoinMetadata<T extends PhantomTypeArgument> implements StructClass { static readonly $typeName = `${PKG_V25}::coin::RegulatedCoinMetadata`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;
...
export class TreasuryCap<T extends PhantomTypeArgument> implements StructClass { static readonly $typeName = `${PKG_V25}::coin::TreasuryCap`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;
