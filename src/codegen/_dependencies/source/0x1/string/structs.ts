...
export class String implements StructClass { static readonly $typeName = `${PKG_V8}::string::String`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;
