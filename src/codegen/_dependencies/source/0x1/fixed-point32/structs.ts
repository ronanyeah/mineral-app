...
export class FixedPoint32 implements StructClass { static readonly $typeName = `${PKG_V8}::fixed_point32::FixedPoint32`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;
