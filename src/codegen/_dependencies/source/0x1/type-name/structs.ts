...
export class TypeName implements StructClass { static readonly $typeName = `${PKG_V8}::type_name::TypeName`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;
