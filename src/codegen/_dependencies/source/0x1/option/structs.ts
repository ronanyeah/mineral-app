...
export class Option<Element extends TypeArgument> implements StructClass { static readonly $typeName = `${PKG_V8}::option::Option`; static readonly $numTypeParams = 1; static readonly $isPhantom = [false,] as const;
